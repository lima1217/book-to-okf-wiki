...
book-to-okf-wiki is a local conversion tool. It reads document files you point it at
and writes an OKF-compatible LLM Wiki package to the output directory. It does **not**
upload your files, phone home, or run a network service. The main security surface is:
...
- Only convert documents you trust and have the right to process.
